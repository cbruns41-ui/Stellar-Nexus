...
export function systemHtml(sys, catalog, originShips, opts = {}) {
  ...
  return `
    <div class="sys-panel panel">
      ...
      ${sys.galaxyName ? `<p class="muted" style="margin:0 0 8px">${esc(sys.galaxyName)}${sys.isGate ? " · Sprungtor" : ""}</p>` : ""}
      ${sys.isGate ? `<p class="hint">Öffentliches Sprungtor. Galaxiewechsel: Anflug hierher, 15–30 Minuten Sprung, dann Zielflug. Warp-Forschung nötig, das Tor muss erreichbar sein.</p>` : ""}
