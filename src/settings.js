...
const SCHEMA = [
  ...
  { key: "dailyNex", type: "int", group: "Premium", label: "Tages-Nex F2P", default: 5, min: 0, max: 200 },
  { key: "dailyNexVip", type: "int", group: "Premium", label: "Tages-Nex Pass", default: 10, min: 0, max: 400 },
